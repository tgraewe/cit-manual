  ...
  return (
    <div className="container">
      ...
      <section>
        <h2>Introduction</h2>
        <p>
          Lab Reports are a fundamental pillar in Purdue’s Computer and Information Technology (CIT) department, such as CNIT 24200, CNIT 34400, and so forth. These reports serve two key purposes: they contribute a significant chunk to your course grade, and they help you develop the necessary professional documentation skills essential for careers in general IT, cybersecurity, and network infrastructure.
        </p>
        <p>
          This manual provides a breakdown approach to writing CIT lab reports, for newcomers to the CIT program as well as students outside the program who must earn credit from CNIT courses. Whether you are a first-time student unfamiliar with technical writing or a returning student looking to brush up on your lab reports, this guide will help you understand each section’s expectations and how to fulfill them effectively in a checklist-style and easily digestible format from the perspective of a student who graduated the program and graded 100+ lab reports.
        </p>
      </section>
      ...
      <section>
        ...
        <ul>
          <li>Table of Contents is present and complete with all sections</li>
          <li>Table of Contents has correct page numbers and leading dots from section name to page number</li>
        </ul>
      ...
      <section>
        ...
        <p>
          Although this section appears early in the report, it should be written last since it summarizes the entire lab. It should briefly explain:
        </p>
        <ul>
          <li>Concise</li>
      ...
      <section>
        ...
        <ul>
          <li>The business case is explained as such that the technology used is appropriate</li>
          <li>Provides the relevant backstory / corporate scenario that led to this project being necessary</li>
      ...
      <section>
        ...
        <ul>
          ...
          <li>Adequate information is provided to allow the re-creation of work</li>
